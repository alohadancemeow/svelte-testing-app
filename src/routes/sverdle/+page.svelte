...
>
  ...
  >
    {#each Array.from(Array(6).keys()) as row (row)}
      ...
      <div data-testid="game-row-{row}" class="row" class:current>
  ...
  <div data-testid="game-controls" class="controls">
    {#if won || data.answers.length >= 6}
      {#if !won && data.answer}
        <p data-testid="answer-reveal">the answer was "{data.answer}"</p>
      {/if}
      <button
    ...
    {:else}
      <div data-testid="keyboard" class="keyboard">
        <button
        ...
        {#each ["qwertyuiop", "asdfghjkl", "zxcvbnm"] as row (row)}
          <div data-testid="keyboard-row-{row}" class="row">
